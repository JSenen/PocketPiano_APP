...
public class SampleGattAttributes {
    ...
    public static String NORDIC_UART_CHARACTERISTIC_TX = "6e400003-b5a3-f393-e0a9-e50e24dcca9e";
    public static String NORDIC_UART_CHARACTERISTIC_RX = "6e400002-b5a3-f393-e0a9-e50e24dcca9e";
    public static String MIDI_SERVICE = "03B80E5A-EDE8-4B33-A751-6CE34EC4C700";
    public static String MIDI_CHARACTERISTIC = "7772E5DB-3868-4112-A1A9-F2669D106BF3";

    static {
        // Sample Services.
        attributes.put("6e400001-b5a3-f393-e0a9-e50e24dcca9e", "Nordic UART Service");
        attributes.put("0000fe59-0000-1000-8000-00805f9b34fb", "Nordic DFU Service");
        attributes.put("03B80E5A-EDE8-4B33-A751-6CE34EC4C700", "MIDI Ble");
        ...
        attributes.put("6e400002-b5a3-f393-e0a9-e50e24dcca9e", "UART RX");
        attributes.put("6e400003-b5a3-f393-e0a9-e50e24dcca9e", "UART TX");
        attributes.put("8ec90003-f315-4f60-9fb8-838830daea50", "Nordic Buttonless Service");
        attributes.put("8ec90004-f315-4f60-9fb8-838830daea50", "Nordic Buttonless Bonded Service");

        attributes.put("0000BAA1-0000-1000-8000-00805f9b34fb", "Cata Debug Serial Reception");
        attributes.put("0000BAA2-0000-1000-8000-00805f9b34fb", "Cata Debug Serial Transmission");
        attributes.put("0000BAA3-0000-1000-8000-00805f9b34fb", "Cata Debug Sample sequence");
        attributes.put("0000BAA4-0000-1000-8000-00805f9b34fb", "Cata Debug IAQ data");
        attributes.put("0000BAA5-0000-1000-8000-00805f9b34fb", "Cata Debug TVOC data");
        attributes.put("0000BAA6-0000-1000-8000-00805f9b34fb", "Cata Debug CO2 data");
        attributes.put("0000BAA7-0000-1000-8000-00805f9b34fb", "Cata Debug other data");
        attributes.put("0000BAA8-0000-1000-8000-00805f9b34fb", "Cata Debug Silent reset");
